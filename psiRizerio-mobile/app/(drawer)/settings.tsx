...
import { View, StyleSheet, ScrollView, TouchableOpacity, Image, useColorScheme, TextInput } from 'react-native';
...
export default function SettingsScreen() {
  ...
  const updateField = (field: string, value: string, subfield?: string) => {
    setProfileData(prev => {
      if (subfield) {
        return {
          ...prev,
  ...
  const Section = ({ id, title, children, showEdit }: { id: string; title: string; children: React.ReactNode; showEdit?: boolean }) => {
  ...
  const InfoRow = ({ sectionId, label, value, field, subfield }: { sectionId: string; label: string; value: string; field: string; subfield?: string }) => {
